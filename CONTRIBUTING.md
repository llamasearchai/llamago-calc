# Contributing to LlamaGo Calc

Thank you for your interest in contributing to LlamaGo Calc! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaGo Calc:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamago-calc.git
   cd llamago-calc
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamago-calc.git
   ```
...
By contributing to LlamaGo Calc, you agree that your contributions will be licensed under the project's MIT License.
