...
const (
	HealthService_Health_FullMethodName = "/proto.HealthService/Health"
)
...
func (c *healthServiceClient) Health(ctx context.Context, in *HealthCheckRequest, opts ...grpc.CallOption) (*HealthCheckResponse, error) {
...
func (UnimplementedHealthServiceServer) Health(context.Context, *HealthCheckRequest) (*HealthCheckResponse, error) {
...
func _HealthService_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthServiceServer).Health(ctx, req.(*HealthCheckRequest))
	}
...
var HealthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "LlamaCalc/pkg/proto/health.proto",
}
